...
export const { changeLeftItems, changeRightItems, changeFlashCalcElement, changeActive, changeWindowFlash, changeHasElement, changeFlashElement } = calculatorDataSlice.actions;
