...
function CalculatorRightContent() {
  return (
    <div className="calc-wrapper">
      <div className="calculator__container">
        ...
        <p className="calc__text">Перетащите сюда</p>
        <p className="">любой элемент из левой панели</p>
      </div>
    </div>
  );
}

export default CalculatorRightContent;
